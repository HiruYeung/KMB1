  ...
  try {
    ...
    if (filteredRoutes.length > 0) {
      ...
      filteredRoutes.forEach(route => {
        ...
        routeElement.textContent = `Route: ${route.route} | Bound: ${route.bound} | Service_type: ${route.service_type} `;
        ...
        routeElement2.addEventListener('click', () => showRouteDetails(route));
        //-----------------//
    ...
    routeResults.innerHTML = '1.An error occurred while fetching the data.';
  }
}
//Show Routes--------------------------------------//
